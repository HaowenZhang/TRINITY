...
# This is the python wrapper of the C binary file, TRINITY/bin/gen_qf,
# which generates galaxy quenched fraction in the redshift bin
# (z_low, z_high), as a function of galaxy mass.
