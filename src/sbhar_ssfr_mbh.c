// Calculate the average specific SMBH accretion rate to specific 
// star formation rate ratio as a function of SMBH mass at a given redshift.
#include <stdlib.h>
#include <stdio.h>
#include <math.h>
...
int main(int argc, char **argv)
{
  ...
  printf("#BH_Mass SBHAR_SSFR_avg\n");

  for (m=5; m<10.5; m+=0.1) 
  {
    printf("%f %e\n", m, calc_sbhar_ssfr_mbh(m, z));
  }
  return 0;
}
