// Calculate the average SMBH accretion rate as a function of galaxy mass
// at a given redshift.
#include <stdlib.h>
#include <stdio.h>
#include <math.h>
...
int main(int argc, char **argv)
{
  ...
  printf("#Mstar BHAR_avg\n");
  for (m=8; m<12.5; m+=0.1) 
  {
    printf("%f %e\n", m, calc_bhar_mstar(m, z)); //See observations.c for the documentation for calc_bhar_mstar().
  }
  // fclose(pfile);
  return 0;
}
