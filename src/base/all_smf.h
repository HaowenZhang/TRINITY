...
// accurate number.
#define NUM_PARAMS 66
#define NUM_SF_PARAMS 32
...
#define QM_0_STEP 0.01
#define QM_1_STEP 0.01
#define QM_2_STEP 0.01
#define QWIDTH_0_STEP 0.01
#define QWIDTH_1_STEP 0.01
#define QWIDTH_2_STEP 0.01

#define F_OCC_MIN_0_STEP 0.01
#define F_OCC_MIN_1_STEP 0.01
...
#define EFF_0_A2(x)  ((x).params[2])
#define EFF_0_A3(x)  ((x).params[3])
#define M_1(x)       ((x).params[4]) // #define M_1(x)       ((x).params[5])
#define M_1_A(x)     ((x).params[5]) // #define M_1_A(x)     ((x).params[6])
#define M_1_A2(x)    ((x).params[6]) // #define M_1_A2(x)    ((x).params[7])
#define M_1_A3(x)    ((x).params[7]) // #define M_1_A3(x)    ((x).params[8])

#define ALPHA(x)      ((x).params[8]) // #define ALPHA(x)      ((x).params[9])
#define ALPHA_A(x)   ((x).params[9]) // #define ALPHA_A(x)   ((x).params[10])
#define ALPHA_A2(x) ((x).params[10]) // #define ALPHA_A2(x) ((x).params[11])
#define ALPHA_A3(x) ((x).params[11]) // #define ALPHA_A3(x) ((x).params[12])

#define BETA(x)      ((x).params[12]) // #define BETA(x)      ((x).params[13])
#define BETA_A(x)   ((x).params[13]) // #define BETA_A(x)   ((x).params[14])
#define BETA_A2(x) ((x).params[14]) // #define BETA_A2(x) ((x).params[15])

#define MU(x)       ((x).params[15]) // #define MU(x)       ((x).params[25])
#define MU_A(x)     ((x).params[16]) // #define MU_A(x)     ((x).params[30])
#define KAPPA(x)    ((x).params[17]) // #define KAPPA(x)    ((x).params[26])
#define KAPPA_A(x)  ((x).params[18]) // #define KAPPA_A(x)  ((x).params[31])

#define SCATTER(x)  ((x).params[19]) // #define SCATTER(x)  ((x).params[27])
#define SCATTER_A(x) ((x).params[20]) // #define SCATTER_A(x) ((x).params[32])
#define SIGMA_Z(x)  ((x).params[21]) // #define SIGMA_Z(x)  ((x).params[28])
#define ICL_FRAC(x) ((x).params[22]) // #define ICL_FRAC(x) ((x).params[29])
#define ICL_FRAC_E(x) ((x).params[23]) // #define ICL_FRAC_E(x) ((x).params[33])
#define ICL_FRAC_Z(x) ((x).params[24]) // #define ICL_FRAC_Z(x) ((x).params[17])
#define RHO_05(x) ((x).params[25]) // #define RHO_05(x) ((x).params[37])

#define QM_0(x) ((x).params[26]) // #define QM_0(x) ((x).params[63])
#define QM_1(x) ((x).params[27]) // #define QM_1(x) ((x).params[64])
#define QM_2(x) ((x).params[28]) // #define QM_2(x) ((x).params[65])
#define QWIDTH_0(x) ((x).params[29]) // #define QWIDTH_0(x) ((x).params[66])
#define QWIDTH_1(x) ((x).params[30]) // #define QWIDTH_1(x) ((x).params[67])
#define QWIDTH_2(x) ((x).params[31]) // #define QWIDTH_2(x) ((x).params[68])

#define DC_MBH_0(x) ((x).params[32])// #define DC_MBH_0(x)           ((x).params[58])
#define DC_MBH_1(x) ((x).params[33]) // #define DC_MBH_1(x) ((x).params[4])
#define DC_MBH_W_0(x) ((x).params[34])// #define DC_MBH_W_0(x) ((x).params[59])
#define DC_MBH_W_1(x) ((x).params[35])// #define DC_MBH_W_1(x) ((x).params[24])
#define F_OCC_MIN_0(x)    ((x).params[36])// #define F_OCC_MIN_0(x)    ((x).params[51])
#define F_OCC_MIN_1(x)    ((x).params[37])// #define F_OCC_MIN_1(x)    ((x).params[52])
#define BH_BETA_0(x)       ((x).params[38]) // #define BH_BETA_0(x)       ((x).params[38])
#define BH_BETA_1(x)       ((x).params[39])// #define BH_BETA_1(x)       ((x).params[39])
#define BH_BETA_2(x)       ((x).params[40])// #define BH_BETA_2(x)       ((x).params[40])
#define BH_GAMMA_0(x)      ((x).params[41])// #define BH_GAMMA_0(x)      ((x).params[41])
#define BH_GAMMA_1(x)      ((x).params[42])// #define BH_GAMMA_1(x)      ((x).params[42])
#define BH_GAMMA_2(x)      ((x).params[43])// #define BH_GAMMA_2(x)      ((x).params[43])
#define BH_SCATTER_0(x)    ((x).params[44])// #define BH_SCATTER_0(x)    ((x).params[55])
#define BH_SCATTER_1(x)    ((x).params[45])// #define BH_SCATTER_1(x)    ((x).params[56])
#define BH_MERGE_F_0(x)    ((x).params[46])// #define BH_MERGE_F_0(x)    ((x).params[49])
#define BH_MERGE_F_1(x)    ((x).params[47])// #define BH_MERGE_F_1(x)    ((x).params[50])
#define BH_ETA_CRIT_0(x) ((x).params[48])// #define BH_ETA_CRIT_0(x) ((x).params[53])
#define BH_ETA_CRIT_1(x) ((x).params[49])// #define BH_ETA_CRIT_1(x) ((x).params[54])
#define BH_ALPHA_0(x)      ((x).params[50])// #define BH_ALPHA_0(x)      ((x).params[44])
#define BH_ALPHA_1(x)      ((x).params[51])// #define BH_ALPHA_1(x)      ((x).params[45])
#define BH_DELTA_0(x)      ((x).params[52])// #define BH_DELTA_0(x)      ((x).params[46])
#define BH_DELTA_1(x)      ((x).params[53])// #define BH_DELTA_1(x)      ((x).params[62])
#define BH_DELTA_2(x)  ((x).params[54])// #define BH_DELTA_2(x)  ((x).params[21])
#define BH_DUTY_M_0(x)   ((x).params[55])// #define BH_DUTY_M_0(x)   ((x).params[22])
#define BH_DUTY_M_1(x)  ((x).params[56])// #define BH_DUTY_M_1(x)  ((x).params[23])
#define BH_DUTY_ALPHA_0(x) ((x).params[57])// #define BH_DUTY_ALPHA_0(x)       ((x).params[47])
#define BH_DUTY_ALPHA_1(x) ((x).params[58])// #define BH_DUTY_ALPHA_1(x)       ((x).params[48])
#define RHO_BH_0(x) ((x).params[59]) // #define RHO_BH_0(x) ((x).params[34])
#define RHO_BH_1(x) ((x).params[60])// #define RHO_BH_1(x) ((x).params[35])
#define RHO_BH_2(x) ((x).params[61])// #define RHO_BH_2(x) ((x).params[36])
#define BH_EFFICIENCY_0(x)     ((x).params[62])// #define BH_EFFICIENCY_0(x)     ((x).params[61])
#define ABHMF_SHIFT(x)         ((x).params[63])// #define ABHMF_SHIFT(x)         ((x).params[57])
#define ETA_MU_0(x)     ((x).params[64])// #define ETA_MU_0(x)     ((x).params[60])
...
#define MODEL_FLAGS(x)     ((x).params[65]) 
