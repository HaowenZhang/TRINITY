...
// as a function of ***intrinsic*** stellar mass.
#include <stdlib.h>
#include <stdio.h>
#include <math.h>
...
int main(int argc, char **argv)
{
  ...
  // Set up the PSF for stellar mass functions. For intrinsic
  // stellar masses, we use setup_psf(0) instead of setup_psf(1). See observations.c.
  setup_psf(0);
