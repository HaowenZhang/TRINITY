...
#define ERFC_CACHE_MIN -32
#define ERFC_CACHE_MAX 32
#define 

double erfc_cache[

double gen_erfc_cache(void) {

}

double adaptiveGauss(double (*f)(double, void *), void *extra_data,
		     double inv_sigma, double epsilon, int maxRecursionDepth)
{
