...
double eigenvalues[NUM_PARAMS] = { EFF_0_STEP, EFF_0_A_STEP, EFF_0_A2_STEP, EFF_0_A3_STEP, 
                                   M_1_STEP, M_1_A_STEP, M_1_A2_STEP, M_1_A3_STEP, 
                                   ALPHA_STEP, ALPHA_A_STEP, ALPHA_A2_STEP, ALPHA_A3_STEP, 
				                            BETA_STEP, BETA_A_STEP, BETA_A2_STEP,
	                                 MU_STEP, MU_A_STEP, KAPPA_STEP,KAPPA_A_STEP, 
                        				   SCATTER_STEP, SCATTER_A_STEP, SIGMA_Z_STEP, 
                                   ICL_STEP, ICL_FRAC_E_STEP, ICL_FRAC_Z_STEP,
                        				   RHO_05_STEP,
                                   QM_0_STEP, QM_1_STEP, QM_2_STEP,
                                   QWIDTH_0_STEP, QWIDTH_1_STEP, QWIDTH_2_STEP,

                                   DC_MBH_0_STEP, DC_MBH_0_STEP, DC_MBH_W_0_STEP, DC_MBH_W_0_STEP,
                                   F_OCC_MIN_0_STEP, F_OCC_MIN_1_STEP,
                                   ...
                                   BH_ETA_0_STEP, BH_ETA_1_STEP,
                                   BH_ALPHA_0_STEP, BH_ALPHA_1_STEP, 
                                   BH_DELTA_0_STEP, BH_DELTA_1_STEP, BH_DELTA_1_STEP,
                                   BH_DUTY_0_STEP, BH_DUTY_1_STEP,
                                   BH_DUTY_0_STEP, BH_DUTY_1_STEP,
                                   RHO_BH_STEP, RHO_BH_STEP, RHO_BH_STEP,
                                   BH_EFFICIENCY_0_STEP,
                                   ETA_MU_0_STEP, ETA_MU_0_STEP, 
...
double eigenvalues_original[NUM_PARAMS] = { EFF_0_STEP, EFF_0_A_STEP, EFF_0_A2_STEP, EFF_0_A3_STEP, 
                                   M_1_STEP, M_1_A_STEP, M_1_A2_STEP, M_1_A3_STEP, 
                                   ALPHA_STEP, ALPHA_A_STEP, ALPHA_A2_STEP, ALPHA_A3_STEP, 
                                    BETA_STEP, BETA_A_STEP, BETA_A2_STEP,
                                   MU_STEP, MU_A_STEP, KAPPA_STEP,KAPPA_A_STEP, 
...
float all_smf_chi2_err(struct smf_fit test) 
{
  ...
  if (fabs(KAPPA(test))>KAPPA_PRIOR*2.5 || 
      ...
      BH_DUTY_ALPHA_0(test) * smf_limit.bh_duty_alpha < 0 ||
 ...
 // fprintf(stderr, "err_code: %d\n", err_code);
  ...
  chi2 += pow((ABHMF_SHIFT(test) - ABHMF_SHIFT_PRIOR)/ABHMF_SHIFT_WIDTH, 2);
...
float all_smf_chi2_err_write(struct smf_fit test) 
{
  ...
  for (i=0; i < 11; i++)
    fprintf(stderr, "%d %f ", i, chi2_type[i]);
...
int mcmc_smf_fit(int length, int run) 
{
  ...
  last_chi2 = all_smf_chi2_err(initial_smf_fit);
