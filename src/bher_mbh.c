// Calculate the average SMBH Eddington ratio as a function of SMBH mass
// at a given redshift.
#include <stdlib.h>
#include <stdio.h>
#include <math.h>
...
int main(int argc, char **argv)
{
  ...
  printf("#BH_Mass BHER_avg\n");


  for (m=5; m<10.5; m+=0.1) 
  {
    printf("%f %e\n", m, calc_bher_mbh(m, z)); //See observations.c for the documentation for calc_bher_mbh().
  }
  // fclose(pfile);
  return 0;
}
