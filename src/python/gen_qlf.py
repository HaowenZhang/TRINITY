...
# This is the python wrapper of the C binary file, TRINITY/bin/gen_qlf,
# which generates quasar bolometric luminosity function at an input redshift,
# on a grid of quasar luminosity.
