...
// in different Eddington ratio bins at redshift z, 
...
int main(int argc, char **argv)
{
  ...
  // Eddington ratio bins.
  for (l=-10; l>-34.1; l-=0.1) 
  {
    for (eta=-3; eta<=0; eta+=1)
      printf("%f %f %f %f\n", l, eta, eta+1, log10(calc_quasar_lf_eta(l, z, eta, eta+1))); //, log10(calc_quasar_lf(l+6.25, z))-2.5);
  }
